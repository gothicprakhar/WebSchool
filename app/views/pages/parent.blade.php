...
@section('page_content')
                     ...
                     <div class="mdl-grid">
                         ...
                         <div class="mdl-cell mdl-cell--10-col mdl-grid">
                          <div class="parent-card-wide mdl-card mdl-shadow--2dp">

                           <div class="mdl-card__title" style="z-index: 0;">
                               <!-- Colored FAB button with ripple -->

                               <h2 class="mdl-card__title-text"><i class="material-icons" style="margin-left: 3em;">person</i>&nbsp;Parent</h2>
        ...
        function showstudents(classid) {
            ...
            $.ajax({
              ...
              success: function (e) {
                 ...
                 // console.log(arr[0].fathername);
                  var tbhtml = "<table  style=\"width: 95%; margin-top: 3em; line-height: 5em; font-size: 1.1em;\" rules=\"rows\" cellspacing=\"60\"><tr><th class=\"hide-mobile\">No </th><th>Student Name</th><th>Father Name</th><th>Mother Name</th><th class=\"hide-mobile\">Phone No</th><th class=\"hide-mobile\">Email</th><th >Action </th> </tr>";
                  ...
                  for(var i = 0; i < arr.length; i++) {
                      ...
                      tbhtml += "</td>";
                      tbhtml += "<td>";
                      tbhtml += arr[i].fathername;
                      tbhtml += "</td>";
                      tbhtml += "<td>";
                      tbhtml += arr[i].mothername;
                      tbhtml += "</td>";
