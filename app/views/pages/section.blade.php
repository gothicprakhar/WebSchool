...
@section('page_content')
                     ...
                     <div class="mdl-grid">
                         ...
                         <div class="mdl-cell mdl-cell--10-col mdl-grid">
                          <div class="section-card-wide mdl-card mdl-shadow--2dp">

                           <div class="mdl-card__title" style="z-index: 0;">
                               <!-- Colored FAB button with ripple -->

                               <h2 class="mdl-card__title-text"><i class="material-icons" style="margin-left: 3em;">kitchen</i>&nbsp;Section</h2>
